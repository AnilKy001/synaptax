...
def make_eprop_ALIF_timeloop(model, loss_fn, unroll: int = 10, burnin_steps: int = 30):
    ...
    """
    # TODO: check gradient equivalence!
    def SNN_eprop_ALIF_timeloop(in_seq, target, z0, u0, a0, G_W_u0, G_W_a0, W0, W_out0, W_out, W):
        # def burnin_loop_fn(carry, in_seq):
        #     z, u, a = carry
...
def make_stupid_eprop_ALIF_timeloop(model, loss_fn, unroll: int = 10, burnin_steps: int = 30):
    ...
    """
    # TODO: check gradient equivalence!
    def SNN_stupid_eprop_ALIF_timeloop(in_seq, target, z0, u0, a0, G_W_u0, G_W_a0, W0, W_out0, W_out, W):
        def loop_fn(carry, in_seq):
